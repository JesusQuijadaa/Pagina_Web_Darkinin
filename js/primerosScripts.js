...
let valoracionesDeUsuario =parseInt( prompt("Calificanos del 1 al 10.\nSiendo 1 el valor mas bajo y 10 el valor mas alto."));


for(let i = 0; i <200; i++){
    

    if(isNaN(valoracionesDeUsuario)){
        valoracionesDeUsuario = parseInt(prompt("El valor ingresado no es un numero, intente nuevamente")) 

    }else if(valoracionesDeUsuario > 10){
        valoracionesDeUsuario = parseInt( prompt("El valor ingresado es mayor a 10.\nCalificanos del 1 al 10.\nSiendo 1 el valor mas bajo y 10 el valor mas alto."));
    }else{
